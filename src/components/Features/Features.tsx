            ...
            <div className="container py-5">
                ...
                <div className="row g-5">
                    ...
                    <div className="col-lg-4  wow zoomIn" data-wow-delay="0.9s" style={{ "minHeight": "350px" }}>
                        ...
                        <div className="d-flex position-relative h-100 justify-content-center">
                            <img className="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.1s" src={FeatureImg} style={{ "objectFit": "cover" }} />
                        </div>
                    </div>
                    <div className="col-lg-4">
                        <div className="row g-5">
